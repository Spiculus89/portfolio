      ...
      <main className=" bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className=" min-h-screen ">
          <nav className=" py-10 mb-12 flex justify-between">
            <h1 className=" text-xl font-burtons dark:text-gray-400">Developedbyme</h1>
          ...
          <div className=" text-center p-10 ">
            ...
            <h3 className="text-2xl py-2 md:text-3xl dark:text-gray-400">Web Developer</h3>
            <p className=" text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-gray-500">
              Bacon ipsum dolor amet pancetta meatball ribeye swine ground
              round. Pork shoulder jerky, prosciutto short ribs rump beef ribs
              beef cupim leberkas ham pig pork belly.
            </p>
          </div>
        ...
        <section>
          <div>
            <h3 className="text-3xl py-1 dark:text-gray-400 mt-12 text-center">Services I offer</h3>
        ...
        <section>
          <div>
            <h3 className="text-3xl py-1 dark:text-gray-400 mt-12 text-center">Portfolio</h3>
            <p className=" text-md py-2 leading-8 text-gray-800 dark:text-gray-500">
              Bacon ipsum dolor amet pancetta meatball ribeye swine ground
              round. Pork shoulder jerky, prosciutto short ribs rump beef ribs
              beef cupim leberkas ham pig pork belly.
